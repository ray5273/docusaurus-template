...
if (Array.isArray(sidebarUserguide) && sidebarUserguide.length > 0) {
  sidebars.sidebarUserguide = sidebarUserguide;
}

if (Array.isArray(sidebarSRS) && sidebarSRS.length > 0) {
  sidebars.sidebarSRS = sidebarSRS;
}
